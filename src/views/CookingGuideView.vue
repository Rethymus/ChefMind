<template>
  <div class="cooking-guide-view">
    ...
    <div class="cooking-header">
      <div class="header-content">
        ...
        <div class="cooking-controls">
          <el-button v-if="!isStarted" type="primary" size="large" @click="startCooking">
          ...
          <el-button v-if="isStarted" type="danger" size="large" @click="stopCooking">
    ...
    <div class="current-step-section" v-if="isStarted">
      <el-card class="step-card">
        <template #header>
          <div class="step-header">
            ...
            <div class="step-navigation">
              <el-button :disabled="currentStep === 0" @click="previousStep" circle>
                <el-icon><ArrowLeft /></el-icon>
              </el-button>
              <el-button :disabled="currentStep === totalSteps - 1" @click="nextStep" circle>
        ...
        <div class="step-actions">
          ...
          <el-button v-else type="success" size="large" @click="completeCooking">
    ...
    <!-- 完成烹饪对话框 -->
    <el-dialog v-model="showCompletionDialog" title="烹饪完成！" width="500px" :show-close="false">
...
<script setup lang="ts">
  ...
  import { formatServings } from '@/utils/formatUtils'
  ...
  const stopCooking = () => {
    ElMessageBox.confirm('确定要结束烹饪吗？进度将不会保存。', '结束烹饪', {
