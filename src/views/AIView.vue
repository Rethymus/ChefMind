        ...
        <div class="generator-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <el-select v-model="cookingTime" placeholder="选择制作时间" size="large">
            ...
            <div class="form-group">
              ...
              <el-select v-model="difficulty" placeholder="选择难度" size="large">
      ...
      <el-card class="recipe-card" shadow="hover">
        <div class="recipe-header">
          ...
          <div class="recipe-image" v-if="generatedRecipe.image">
            <img :src="generatedRecipe.image" :alt="generatedRecipe.title || generatedRecipe.name" />
          </div>
        </div>
          ...
          <div class="content-section ingredients-section">
            ...
            <div class="ingredients-grid">
              ...
              >
                ...
                <el-tag v-if="isAutoCompletedIngredient(ingredient)" size="small" type="info" class="auto-completed-tag">AI补充</el-tag>
              </div>
            </div>
          </div>
          ...
          <div class="content-section nutrition-section" v-if="generatedRecipe.nutrition">
            ...
            <div class="nutrition-grid">
              ...
              <div class="nutrition-item">
                ...
                <div class="nutrition-value">{{ generatedRecipe.nutrition.carbs || generatedRecipe.nutrition.carbohydrates }}g</div>
              </div>
              <div class="nutrition-item">
      ...
      <el-card class="history-card" shadow="hover">
        <template #header>
          <div class="card-header">
            ...
            <el-button size="small" link @click="clearHistory">
              清空历史
            </el-button>
          </div>
        </template>
...
import {
  Setting, Apple, Dish, Tools, User, Clock, Star, Warning, MagicStick,
  ShoppingBag, List, DataAnalysis, Opportunity, Check, PriceTag,
  Collection, Share, Refresh, Timer, ArrowRight, Plus, InfoFilled,
  ShoppingCart, CirclePlus
...
const commonIngredients = [
  '鸡蛋', '土豆', '番茄', '洋葱', '大蒜', '生姜', '猪肉', '鸡肉', 
  '大米', '面条', '豆腐', '青椒', '胡萝卜', '白菜'
]

// 食材分类
const vegetableIngredients = [
  '土豆', '番茄', '洋葱', '大蒜', '生姜', '胡萝卜', '青椒', '白菜', 
  '菠菜', '韭菜', '豆角', '茄子', '冬瓜', '南瓜', '莲藕', '山药', 
  '玉米', '蘑菇', '木耳', '银耳', '豆芽', '芹菜', '黄瓜', '西红柿'
]

const meatIngredients = [
  '猪肉', '牛肉', '鸡肉', '鸭肉', '鱼', '虾', '蟹', '鸡蛋', 
  '豆腐', '腊肉', '香肠', '培根', '羊肉', '排骨', '鸡翅', '鱼片'
]

const stapleIngredients = [
  '大米', '面条', '面粉', '馒头', '面包', '土豆', '红薯', 
  '玉米', '小米', '燕麦', '意大利面', '河粉', '米粉', '饺子皮'
]

const seasoningIngredients = [
  '盐', '生抽', '老抽', '料酒', '白糖', '香油', '胡椒粉', 
  '花椒', '八角', '桂皮', '香叶', '蚝油', '醋', '辣椒油'
]
...
const validateIngredientWithAI = async (ingredient: string): Promise<boolean> => {
  try {
    ...
    // 模糊匹配
    const isCommon = commonIngredientsList.some(common => 
