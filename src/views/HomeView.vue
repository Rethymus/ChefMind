  ...
  <div class="home-view">
    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          <router-link to="/ai" class="cta-button primary">
      ...
      <div class="hero-image">
        <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=400&fit=crop" alt="美食图片" />
      </div>
    </section>
    ...
    <section class="popular-recipes-section">
      ...
      <div class="section-footer">
        <router-link to="/search" class="view-more-button">
          查看更多菜谱 →
        </router-link>
      </div>
    </section>
