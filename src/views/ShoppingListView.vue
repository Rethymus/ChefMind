      ...
      <div v-else class="shopping-list-container">
        ...
        <div class="list-categories">
          ...
          <div v-if="sortMode === 'recipe'">
            <div v-for="recipe in recipeGroups" :key="recipe" class="recipe-section">
                ...
                >
                  ...
                  <div class="item-actions">
                    ...
                    <button
                      ...
                      @click="removeItem(shoppingList.indexOf(item))"
                    >
                      <span class="action-icon">🗑️</span>
                    </button>
                  </div>
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input id="edit-name" v-model="editingItem.name" type="text" class="form-input" />
          </div>

          <div class="form-group">
            <label for="edit-category">分类</label>
            <select id="edit-category" v-model="editingItem.category" class="form-select">
        ...
        <div class="modal-footer">
          ...
          <button class="confirm-btn" @click="saveEditedItem" :disabled="!editingItem.name.trim()">
            保存
          </button>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const editingItem = ref<ShoppingItem>({
    id: '',
    name: '',
    completed: false,
    category: '食材',
  ...
  const getItemsByRecipe = (recipeName: string) => {
    return shoppingList.value.filter(
      item => (recipeName === '' && !item.recipeName) || item.recipeName === recipeName
    )
  }
