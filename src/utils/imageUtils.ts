...
const ingredientBasedImages: Record<string, string[]> = {
  肉类: ['/images/meat-dish.jpg', '/images/meat-dish.jpg', '/images/meat-dish.jpg'],
  蔬菜: ['/images/vegetables.jpg', '/images/vegetables.jpg', '/images/vegetables.jpg'],
  海鲜: [
    '/images/recipe-general-1.jpg',
    '/images/recipe-general-1.jpg',
    '/images/recipe-general-1.jpg',
  ],
  豆腐: ['/images/recipe-general-2.jpg', '/images/recipe-general-2.jpg'],
  鸡蛋: ['/images/recipe-general-1.jpg', '/images/recipe-general-1.jpg'],
  米饭: ['/images/recipe-general-2.jpg', '/images/recipe-general-2.jpg'],
  面食: ['/images/recipe-general-1.jpg', '/images/recipe-general-1.jpg'],
}

// 按烹饪方式分类的图片集合
const cookingMethodImages: Record<string, string[]> = {
  炒: ['/images/chinese-food-1.jpg', '/images/chinese-food-1.jpg'],
  煮: ['/images/chinese-food-1.jpg', '/images/chinese-food-1.jpg'],
  蒸: ['/images/chinese-food-1.jpg', '/images/chinese-food-1.jpg'],
  炖: ['/images/chinese-food-1.jpg', '/images/chinese-food-1.jpg'],
  煎: ['/images/meat-dish.jpg', '/images/meat-dish.jpg'],
  烤: ['/images/meat-dish.jpg', '/images/meat-dish.jpg'],
}
