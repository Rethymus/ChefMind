...
export class UserModel {
   ...
   * 创建或更新用户
   */
  async createOrUpdate(sessionId: string, preferences: Record<string, unknown> = {}): Promise<UserDocument> {
    // 检查用户是否已存在
   ...
   * 更新用户偏好设置
   */
  async updatePreferences(sessionId: string, preferences: Record<string, unknown>): Promise<UserDocument | null> {
