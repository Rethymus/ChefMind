<template>
  <div class="ai-hub">
      ...
      <el-tabs v-model="activeTab" @tab-change="handleTabChange">
        ...
        <el-tab-pane label="💬 智能助手" name="chat-assistant">
          <IntelligentChatAssistant
            ...
            @recipe-request="handleRecipeRequest"
            @cooking-help="handleCookingHelp"
          />
        </el-tab-pane>
      </el-tabs>
    </div>
    ...
    <!-- AI 提供商设置对话框 -->
    <el-dialog
      v-model="providerSettingsVisible"
      title="⚙️ AI 提供商设置"
      width="90%"
      max-width="800px"
    >
...
<script setup lang="ts">
  ...
  import AdvancedNutritionAnalyzer from './AdvancedNutritionAnalyzer.vue'
