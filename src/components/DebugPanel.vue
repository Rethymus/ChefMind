    ...
    <div class="debug-content">
      ...
      <div class="debug-section">
        ...
        <div class="debug-actions">
          <button @click="openDevTools" class="debug-btn">
            📱 打开开发者工具
          </button>
          <button @click="checkConsole" class="debug-btn">
            📝 检查控制台
          </button>
          <button @click="clearLogs" class="debug-btn">
            🗑️ 清除日志
          </button>
        </div>
      </div>
      ...
      <div class="debug-section">
        ...
        <div class="debug-actions">
          ...
          <button @click="testDatabase" class="debug-btn">
            💾 测试数据库
          </button>
          <button @click="reloadApp" class="debug-btn">
            🔄 重新加载应用
          </button>
        </div>
      </div>
