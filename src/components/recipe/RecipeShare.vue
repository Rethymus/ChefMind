...
const generateImage = async () => {
  try {
    ...
    const infoItems = [
      { label: '烹饪时间', value: props.recipe.cookingTime, icon: '⏱️' },
      { label: '难度', value: props.recipe.difficulty, icon: '📊' },
      { label: '份量', value: props.recipe.servings || '2人份', icon: '🍽️' }
    ]
