  ...
  <div class="ai-enhanced-features">
    ...
    <div class="ai-features-panel space-y-4">
      ...
      <div class="feature-card">
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <div class="flex items-center gap-2 mt-2">
                  ...
                  <span class="text-xs text-gray-500"> {{ recipe.cookingTime }}分钟 </span>
                </div>
              </div>
        ...
        <div v-else class="text-gray-500 text-sm">选择食材后，AI将为您推荐相关的美味菜谱</div>
      </div>

      <!-- AI生成标识 -->
      <div v-if="currentRecipe?.aiGenerated" class="ai-generated-badge">
        <div
          class="flex items-center gap-2 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200"
        >
...
<script setup lang="ts">
  ...
  // const recipeService = useRecipeService() // 待实现的功能
  ...
  const analyzeNutrition = async () => {
    ...
    try {
      ...
      nutritionAnalysis.value = '营养分析功能待实现'
      apiUsageCount.value++
    } catch (error) {
