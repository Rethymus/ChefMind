      ...
      <div v-if="allergenInfo" class="allergen-info">
        ...
        <div v-if="allergenInfo.safe.length > 0" class="allergen-safe">
          ...
          <div>
            ...
            <div class="allergen-list">
              <span v-for="safe in allergenInfo.safe" :key="safe" class="allergen-tag safe">
                {{ safe }}
              </span>
            </div>
          </div>
        ...
        <div v-if="allergenInfo.alternatives.length > 0" class="allergen-alternatives">
          ...
          <div class="alternatives-grid">
            <div v-for="alt in allergenInfo.alternatives" :key="alt.from" class="alternative-card">
              <div class="from-to">
  ...
  const parseNutritionOptimizationFromAI = (text: string): NutritionOptimization => {
    try {
      ...
      return {
        ...
        suggestions:
          suggestions.length > 0 ? suggestions : generateFallbackOptimization().suggestions,
      }
    } catch (error) {
