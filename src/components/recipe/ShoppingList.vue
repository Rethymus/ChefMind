  ...
  <div class="shopping-list">
    <div class="shopping-header">
      ...
      <div class="header-actions">
        <button class="generate-btn" @click="generateFromRecipes" :disabled="!hasSelectedRecipes">
    ...
    <div class="shopping-content" v-if="shoppingItems.length > 0">
            ...
            >
              ...
              <div class="item-info">
                ...
                <div class="item-details">
                  ...
                  <span class="price" v-if="item.estimatedPrice"> ¥{{ item.estimatedPrice }} </span>
              ...
              <div class="item-actions">
                <button class="action-btn edit" @click="editItem(item)" title="编辑">
                ...
                <button class="action-btn delete" @click="removeItem(item.id)" title="删除">
      ...
      <div class="shopping-actions">
        ...
        <button class="action-button export" @click="exportList">
          <el-icon><Download /></el-icon>
          导出清单
        </button>
        <button class="action-button share" @click="shareList">
    ...
    <div class="empty-state" v-else>
      ...
      <div class="empty-actions">
        ...
        <button class="btn btn-secondary" @click="showAddItemModal = true">
          <el-icon><Plus /></el-icon>
          手动添加
        </button>
      </div>
...
<script setup lang="ts">
  ...
  const filteredCategories = computed(() =>
    selectedCategory.value === 'all'
      ? categories.slice(1)
      : categories.filter(cat => cat.id === selectedCategory.value)
  )
        ...
        recipe.ingredients.forEach(ingredient => {
          ...
          const existingItem = shoppingItems.value.find(
            item =>
              ...
              item.category === getCategoryByIngredient(ingredientName)
          )
  ...
  // 导出清单
  const exportList = () => {
    const content = shoppingItems.value
      .map(
        item =>
  ...
  const shareList = () => {
    const content =
      `ChefMind 购物清单 (${totalItems.value}项商品)\n` +
      shoppingItems.value
