...
const emit = defineEmits<{
  (e: 'update:dietaryRestrictions', value: string[]): void
  (e: 'update:healthGoals', value: string[]): void
  (e: 'update:allergies', value: string[]): void
  (e: 'update:flavors', value: string[]): void
}>()
...
const dietaryHabits: RestrictionItem[] = [
  ...
  { id: 'mediterranean', name: '地中海饮食', description: '富含橄榄油、鱼类和蔬果', type: 'habits' },
...
const allergens: RestrictionItem[] = [
  ...
  { id: 'nightshades', name: '茄科植物', description: '避免番茄、茄子、辣椒等', type: 'allergies' }
]
...
const getTagType = (type: string) => {
  switch (type) {
    ...
    case 'goals': return 'primary'
    case 'allergies': return 'danger'
    case 'flavors': return 'warning'
    default: return ''
  }
}
