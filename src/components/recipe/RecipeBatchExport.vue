<template>
  <div class="recipe-batch-export">
    ...
    <div class="export-actions">
      <button class="btn-copy" @click="copyToClipboard" :disabled="selectedRecipes.length === 0">
        <span class="btn-icon">📋</span>
        复制到剪贴板
      </button>

      <button class="btn-download" @click="downloadFile" :disabled="selectedRecipes.length === 0">
        <span class="btn-icon">💾</span>
        下载文件
      </button>
    </div>
