      ...
      <div class="recipe-header">
        ...
        <div class="recipe-actions">
          ...
          <div class="action-buttons">
            <button class="action-button cooking" @click="startCooking">
        ...
        <ul class="ingredients-list">
          ...
          >
            <span class="ingredient-icon">{{
              getIngredientIcon(typeof ingredient === 'string' ? ingredient : ingredient.name)
            }}</span>
...
<script setup lang="ts">
  ...
  const startCooking = () => {
    ...
    // 跳转到烹饪指导页面，传递食谱数据
    localStorage.setItem('currentCookingRecipe', JSON.stringify(props.recipe))
    router.push({
      name: 'CookingGuide',
    })
  }
