    ...
    <div class="nutrition-daily">
      ...
      <div class="daily-bars">
        <div class="daily-item" v-if="recipe.nutritionInfo?.calories !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('calories', 2000) + '%' }"></div>
          </div>
        ...
        <div class="daily-item" v-if="recipe.nutritionInfo?.protein !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('protein', 50) + '%' }"></div>
          </div>
        ...
        <div class="daily-item" v-if="recipe.nutritionInfo?.carbs !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('carbs', 300) + '%' }"></div>
          </div>
        ...
        <div class="daily-item" v-if="recipe.nutritionInfo?.fat !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('fat', 65) + '%' }"></div>
          </div>
        ...
        <div class="daily-item" v-if="recipe.nutritionInfo?.fiber !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('fiber', 25) + '%' }"></div>
          </div>
        ...
        <div class="daily-item" v-if="recipe.nutritionInfo?.sodium !== undefined">
          ...
          <div class="daily-bar">
            <div class="daily-progress" :style="{ width: calculateDailyPercentage('sodium', 2300) + '%' }"></div>
          </div>
...
const calculateDailyPercentage = (nutrient: string, dailyValue: number) => {
  if (!props.recipe.nutritionInfo || !props.recipe.nutritionInfo[nutrient as keyof typeof props.recipe.nutritionInfo]) return 0
  
  const value = props.recipe.nutritionInfo[nutrient as keyof typeof props.recipe.nutritionInfo] as number
...
const drawNutritionChart = () => {
  ...
  const _fatPercentage = (fat / total) * 100
