<template>
  <div class="recipe-comments">
        ...
        <div class="average-rating" v-if="averageRating > 0">
          ...
          <div class="stars">
            <span
              v-for="i in 5"
              :key="`avg-${i}`"
              :class="['star', { filled: i <= Math.round(averageRating) }]"
              >★</span
            >
          </div>
    ...
    <div class="comment-form">
      ...
      <button class="submit-button" @click="submitComment" :disabled="!canSubmit">发布评论</button>
    </div>
        ...
        <div class="comment-header">
          ...
          <div class="comment-rating">
            <span
              v-for="i in 5"
              :key="`comment-${index}-${i}`"
              :class="['star', { filled: i <= comment.rating }]"
              >★</span
            >
          </div>
        </div>
