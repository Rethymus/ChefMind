    ...
    return [
      {
        ...
        source: import.meta.env.VITE_OPENAI_API_KEY
          ? 'env'
          : dbConfigs.openai?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_GLM_API_KEY
          ? 'env'
          : dbConfigs.glm?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_ANTHROPIC_API_KEY
          ? 'env'
          : dbConfigs.anthropic?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_GOOGLE_API_KEY
          ? 'env'
          : dbConfigs.google?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_DEEPSEEK_API_KEY
          ? 'env'
          : dbConfigs.deepseek?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_MOONSHOT_API_KEY
          ? 'env'
          : dbConfigs.moonshot?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_QWEN_API_KEY
          ? 'env'
          : dbConfigs.qwen?.apiKey
            ? 'database'
            : 'none',
      },
      {
        ...
        source: import.meta.env.VITE_HUNYUAN_API_KEY
          ? 'env'
          : dbConfigs.hunyuan?.apiKey
            ? 'database'
            : 'none',
      },
    ]
