...
class AnalyticsService {
  ...
  public getPersonalizedRecommendations(
    userId: string,
    _limit: number = 5
  ): Array<{ id: string; title: string; image: string; reason: string }> {
    // 模拟个性化推荐
    return [
      {
        id: '18',
        title: '蒜蓉粉丝蒸扇贝',
        image:
          'https://images.unsplash.com/photo-1635146037526-a75e6905ad78?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c2NhbGxvcHN8ZW58MHx8MHx8fDA%3D',
        reason: '基于您对海鲜类食谱的兴趣',
      },
      {
        id: '19',
        title: '香辣干锅鸡',
        image:
          'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHNwaWN5JTIwY2hpY2tlbnxlbnwwfHwwfHx8MA%3D%3D',
        reason: '您经常浏览鸡肉类食谱',
      },
      {
        id: '20',
        title: '松露蘑菇意面',
        image:
          'https://images.unsplash.com/photo-1608219992759-8d74ed8d76eb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bXVzaHJvb20lMjBwYXN0YXxlbnwwfHwwfHx8MA%3D%3D',
      ...
      },
      {
        ...
        title: '柠檬草烤鱼',
        image:
          'https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z3JpbGxlZCUyMGZpc2h8ZW58MHx8MHx8fDA%3D',
        reason: '基于您收藏的三文鱼食谱',
      },
      {
        id: '22',
        title: '芒果椰汁西米露',
        image:
          'https://images.unsplash.com/photo-1615484477778-ca3b77940c25?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWFuZ28lMjBkZXNzZXJ0fGVufDB8fDB8fHww',
        reason: '您可能会喜欢的甜点',
      },
    ]
  }
