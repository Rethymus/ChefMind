...
class MemoryStorage {
  ...
  async find(table: string, query: any = {}, limit: number = 50, offset: number = 0): Promise<any[]> {
    ...
    const sampleRecipes = [
      {
        ...
        instructions: '["将番茄洗净切块", "鸡蛋打散加少许盐", "热锅放油炒蛋", "加入番茄块翻炒", "调味即可出锅"]',
        cooking_time: 15,
        difficulty: '简单',
        servings: 2,
        category: '家常菜',
      ...
      },
      {
        ...
        instructions: '["猪肉切丝用淀粉腌制", "青椒切丝", "热锅炒肉丝", "加入青椒丝翻炒", "调味即可"]',
        cooking_time: 20,
        difficulty: '中等',
        servings: 2,
        category: '川菜',
